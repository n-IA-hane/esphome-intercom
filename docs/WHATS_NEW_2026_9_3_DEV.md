...
shows an optional 20-second delay before forwarding. Remove Delay for immediate
forwarding after the greeting. You can create these steps
...
This update does not require new ESP firmware.
